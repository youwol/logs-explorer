...
[Running app.](https://platform.youwol.com/applications/@youwol/logs-explorer/latest)

[Online user-guide](https://l.youwol.com/doc/@youwol/logs-explorer)

[Developers documentation](https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/logs-explorer&tab=doc)

[Package on npm](https://www.npmjs.com/package/@youwol/logs-explorer)

[Source on GitHub](https://github.com/youwol/logs-explorer)
    ...
    customization = Customization(
        middlewares = [
            FlowSwitcherMiddleware(
                ...
                oneOf = [
                    WebpackDevServerSwitch(packageName="@youwol/logs-explorer", port=3015),
                ]
            )
        ]
    )
...
the application can be accessed from [here](http://localhost:2000/applications/@youwol/logs-explorer/latest)
